...
defaultproperties
{
    ...
    mapIndexes(49)=(mapname="kf-filthscross-s",achvIndex=11)
    mapIndexes(50)=(mapname="kf-foundry-s",achvIndex=5)
    mapIndexes(51)=(mapname="kf-forgotten-s",achvIndex=29)
    mapIndexes(52)=(mapname="kf-frightyard-s",achvIndex=26)
    mapIndexes(53)=(mapname="kf-hellride-s",achvIndex=21)
    mapIndexes(54)=(mapname="kf-hospitalhorrors-s",achvIndex=12)
    mapIndexes(55)=(mapname="kf-icebreaker-s",achvIndex=13)
    mapIndexes(56)=(mapname="kf-northernsolitude-s",achvIndex=36)
    mapIndexes(57)=(mapname="kf-mountainpass-s",achvIndex=14)
