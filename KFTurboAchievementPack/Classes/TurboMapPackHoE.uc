...
defaultproperties
{
    ...
    mapIndexes(39)=(mapname="kf-cubicalchamber",achvIndex=39)
    mapIndexes(40)=(mapname="kf-vagrant-s",achvIndex=40)

    //Modified maps that should still reward the base map achievement.
    mapIndexes(41)=(mapname="kf-abusementparkwinter-s",achvIndex=19)
    mapIndexes(42)=(mapname="kf-aperture-s",achvIndex=18)
    mapIndexes(43)=(mapname="kf-aperture-lights-out",achvIndex=18)
    mapIndexes(44)=(mapname="kf-biohazard-s",achvIndex=8)
    mapIndexes(45)=(mapname="kf-bioticslab-s",achvIndex=4)
    ...
    mapIndexes(58)=(mapname="kf-suburbia-s",achvIndex=15)
    mapIndexes(59)=(mapname="kf-waterworks-s",achvIndex=16)
    mapIndexes(60)=(mapname="kf-westlondon-s",achvIndex=0)
    mapIndexes(61)=(mapname="kf-westlondonwinter-s",achvIndex=0)
    ...
    achievements(39)=(title="Compacted Cube",description="Win a long game on Cubical Chamber on Hell on Earth difficulty",image=Texture'KFTurbo.Achievement.CubicalChamber_HoE')
