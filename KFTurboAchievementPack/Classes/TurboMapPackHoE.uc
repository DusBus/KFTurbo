...
defaultproperties
{
    ...
    mapIndexes(46)=(mapname="kf-bioticslab-s",achvIndex=4)
    mapIndexes(47)=(mapname="kf-crash-s",achvIndex=9)
    mapIndexes(48)=(mapname="kf-departed-s",achvIndex=10)
    mapIndexes(49)=(mapname="kf-departedwinter-s",achvIndex=10)
    mapIndexes(50)=(mapname="kf-evilsantaslair-s",achvIndex=17)
    mapIndexes(51)=(mapname="kf-filthscross-s",achvIndex=11)
    mapIndexes(52)=(mapname="kf-foundry-s",achvIndex=5)
    mapIndexes(53)=(mapname="kf-forgotten-s",achvIndex=29)
    mapIndexes(54)=(mapname="kf-frightyard-s",achvIndex=26)
    mapIndexes(55)=(mapname="kf-hellride-s",achvIndex=21)
    mapIndexes(56)=(mapname="kf-hospitalhorrors-s",achvIndex=12)
    mapIndexes(57)=(mapname="kf-icebreaker-s",achvIndex=13)
